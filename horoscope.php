	...
	<div class="ast_banner_text">
		...
		<div class="container">
			<div class="ast_bannertext_wrapper">
				...
				<a class="ast_btn ast_btn popup-with-zoom-anim" href="#signup-dialog">make it now</a>
			</div>
		</div>
	</div>
</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 col-lg-push-7 col-md-push-7 col-sm-push-0 col-xs-push-0">
				<div class="ast_about_info_img">
					<div class="about_slider">
						<div class="card c" id="first"><img src="images/content/about/hr-abt1.jpg" alt="" class="img-responsive"></div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="ast_search_box">
				...
				<div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
					<button type="submit" class="popup-with-zoom-anim ast_btn" href="#login-dialog">Get now</button>
				</div>
			</div>
			</div>
		</div>
