...
<head>
	<title>Guruji Panel</title>
		...
		<style>
			.backimage
			{
				background-image: url(../images/content/guru1.jpg);
...
<body class="backimage">
		<div class="container">
			<div class="row">
				<div>
					<center><h2>Guruji Login</h2></center>
				</div>
				<div class="col-md-4 col-md-offset-4 admin">
					<form action="guruji_auth.php" method="post" class="form-signin animated shake">
						<div class="form-group">
							<label>Username</label>
							<input type="text" placeholder="guruji Username" name="guru_name" class="form-control">
						</div>
						<div class="form-group">
							<label>Password</label>
							<input type="password" placeholder="Password" name="guru_pass" class="form-control">
						</div>
