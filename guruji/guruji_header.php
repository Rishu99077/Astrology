...
if(! isset($_SESSION['is_guru_logged_in']))
{
...
<body id="page-top">
  <div class="wrapper">
    <nav id="sidebar" class="sidebar bg-success">
      <div class="sidebar-content js-simplebar">
        <a class="sidebar-brand" href="index.php">
            <img src="img/avatars/guru_2.jpg" class="avatar img-fluid rounded mr-1"/>
              <span class="align-middle">Guruji Panel</span>
        ...
        <ul class="sidebar-nav">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="guruji_panel.php">
                    <!-- <i class="align-middle" data-feather="message-square"></i> -->
                    <i class="fas fa-comment-dots text-primary align-middle"></i>
                      <span class="align-middle heading">My profile</span>
                  </a>
          </li>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="guru_logout.php">
          ...
          <li class="nav-item dropdown">
            ...
            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-toggle="dropdown">
             ...
             <!--    <a class="dropdown-item" href="user_profile.php"><i class="align-middle mr-1" data-feather="user"></i> Profile</a>
                ...
                <!-- <div class="dropdown-divider"></div> -->
                <a class="dropdown-item" href="guru_logout.php">Log out</a>
              </div>
            </li>
          </ul>
        </div>
