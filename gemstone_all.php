		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<ul class="breadcrumb">
					...
					<li>//</li>
					<li><a href="gemstone.php">gemstones</a></li>
					<li>//</li>
					<li><a href="gemstone_all.php">gemstones single</a></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
				<div class="ast_blog_box">
					<div class="ast_blog_img">
						...
						<img src="images/content/gemstones_single.jpg" alt="gemstones" title="Gemstones">
					</div>
